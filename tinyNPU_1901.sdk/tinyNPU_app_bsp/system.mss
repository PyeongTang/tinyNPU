...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = IMAGE_RAM_CTRL
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = RESULT_RAM_CTRL
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = tinyNPU
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = tinyNPU_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = FILTER_RAM_CTRL
END
